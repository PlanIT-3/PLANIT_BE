...
import woojooin.planit.domain.goal.api.dto.req.DepositAccountEditListReq;
import woojooin.planit.domain.goal.api.dto.req.DepositAccountRegisterListReq;
import woojooin.planit.domain.goal.api.dto.res.DepositAccountRes;
import woojooin.planit.domain.goal.service.DepositService;
...
public class DepositController {
	...
	public ResponseEntity<Response<List<DepositAccountRes>>> getDepositAccountsByGoalId(
		...
		List<DepositAccountRes> accounts = depositService.findAllByMemberIdAndGoalId(memberId, goalId);
	...
	public ResponseEntity<Response<List<DepositAccountRes>>> getAvailableDepositAccounts(
		...
		List<DepositAccountRes> accounts = depositService.findAvailableAccountsByMemberIdAndGoalId(memberId, goalId);
